...
from helios_auth.url_names import AUTH_INDEX, AUTH_START, AUTH_AFTER, AUTH_WHY, AUTH_AFTER_INTERVENTION, AUTH_LOGOUT
...
from helios_auth.auth_systems import wallet
...
#        and verification['signing_address'] == request.session['addr']
    ...
    if wallet_success:
      return HttpResponseRedirect(reverse(AUTH_AFTER))
    else:
