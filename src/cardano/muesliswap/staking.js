import { STAKING_ADDRESS, STAKING_CONTRACT, STAKING_FEE_ADDRESS } from 'cardano/constants'
...
export async function stakeToken(
  ...
  var output = createOutput(STAKING_ADDRESS(), assetsToValue(assets), datum, hash)
  outputs.add(output)
...
export async function unstakeToken(
  ...
  const plutusWitness = Loader.Cardano.PlutusWitness.new(STAKING_CONTRACT(), datum, redeemer)
