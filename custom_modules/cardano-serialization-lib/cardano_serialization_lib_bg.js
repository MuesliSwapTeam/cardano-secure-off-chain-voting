...
* @returns {DataHash}
*/
export function hash_plutus_data_as_list(plutus_data) {
    _assertClass(plutus_data, PlutusData);
    var ret = wasm.hash_plutus_data_as_list(plutus_data.ptr);
    return DataHash.__wrap(ret);
}
...
* @param {PlutusFixedLengthList | undefined} datums
...
export function hash_script_data(redeemers, language_views, datums) {
    ...
    if (!isLikeNone(datums)) {
        _assertClass(datums, PlutusFixedLengthList);
        ptr0 = datums.ptr;
        datums.ptr = 0;
    }
...
/**
*/
export class PlutusFixedLengthList {

    static __wrap(ptr) {
        const obj = Object.create(PlutusFixedLengthList.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_plutusfixedlengthlist_free(ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    to_bytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.plutusfixedlengthlist_to_bytes(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v0 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1);
    ...
    /**
    * @param {Uint8Array} bytes
    * @returns {PlutusFixedLengthList}
    */
    static from_bytes(bytes) {
        var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.plutusfixedlengthlist_from_bytes(ptr0, len0);
        return PlutusFixedLengthList.__wrap(ret);
    }
    /**
    * @returns {PlutusFixedLengthList}
    */
    static new() {
        var ret = wasm.plutusfixedlengthlist_new();
        return PlutusFixedLengthList.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    len() {
        var ret = wasm.plutusfixedlengthlist_len(this.ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} index
    ...
    */
    get(index) {
        var ret = wasm.plutusfixedlengthlist_get(this.ptr, index);
        return PlutusData.__wrap(ret);
    }
    /**
    ...
    */
    add(elem) {
        ...
        wasm.plutusfixedlengthlist_add(this.ptr, elem.ptr);
    }
}
/**
*/
...
export class TransactionBuilder {
    ...
    */
    ...
    /**
    * @param {PlutusFixedLengthList} plutus_data
    */
    set_plutus_data(plutus_data) {
        _assertClass(plutus_data, PlutusFixedLengthList);
...
export class TransactionWitnessSet {
    ...
    */
    ...
    /**
    * @returns {PlutusFixedLengthList | undefined}
    */
    plutus_data() {
        var ret = wasm.transactionwitnessset_plutus_data(this.ptr);
        return ret === 0 ? undefined : PlutusFixedLengthList.__wrap(ret);
    }
    /**
    * @param {Redeemers} redeemers
    */
