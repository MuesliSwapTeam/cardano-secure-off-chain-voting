...
export function hash_plutus_data_as_list(a: number): number
...
export function __wbg_plutusfixedlengthlist_free(a: number): void
export function plutusfixedlengthlist_to_bytes(a: number, b: number): void
export function plutusfixedlengthlist_from_bytes(a: number, b: number): number
export function plutusfixedlengthlist_new(): number
export function plutusfixedlengthlist_len(a: number): number
export function plutusfixedlengthlist_get(a: number, b: number): number
export function plutusfixedlengthlist_add(a: number, b: number): void
