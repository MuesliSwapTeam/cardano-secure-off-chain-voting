 ...
 * @returns {DataHash}
 */
export function hash_plutus_data_as_list(plutus_data: PlutusData): DataHash
/**
...
export class PlutusFixedLengthList {
   ...
   */
  static from_bytes(bytes: Uint8Array): PlutusFixedLengthList
  /**
   * @returns {PlutusFixedLengthList}
   */
  static new(): PlutusFixedLengthList
  /**
   * @returns {number}
   */
  len(): number
...
export class TransactionBuilder {
   ...
   */
  set_plutus_data(plutus_data: PlutusFixedLengthList): void
  /**
   * @param {Redeemers} redeemers
   */
...
export class TransactionWitnessSet {
   ...
   */
  plutus_data(): PlutusFixedLengthList | undefined
  /**
   * @param {Redeemers} redeemers
   */
  set_redeemers(redeemers: Redeemers): void
